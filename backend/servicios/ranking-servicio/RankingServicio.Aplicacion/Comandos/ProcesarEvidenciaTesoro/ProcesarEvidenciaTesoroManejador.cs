    ...
    : IRequestHandler<ProcesarEvidenciaTesoroComando>
{
    ...
    public async Task Handle(ProcesarEvidenciaTesoroComando comando, CancellationToken cancelacion)
    {
        ...
        _log.LogInformation(
            "Emitiendo PuntajeCalculado Tesoro. EventoId={EventoId} SesionId={SesionId} ParticipanteSesionId={ParticipanteSesionId} PuntajeGanado={PuntajeGanado} PuntajeTotalParticipante={PuntajeTotalParticipante}",
