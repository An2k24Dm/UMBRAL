...
// Pruebas del manejador de archivado de búsqueda del tesoro.
public class ArchivarBusquedaTesoroManejadorPruebas
{
    ...
    private ArchivarBusquedaTesoroManejador CrearManejador() => new(_repositorio.Object);
    ...
    [Fact]
    public async Task Handle_BusquedaExistente_LlamaArchivarAsyncUnaVez()
    {
